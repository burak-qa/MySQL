...
-- ============================== DELETE ===================================  
	...
	savepoint abc; -- eger silersek bu cop kutusu oluyor. geriye getirme ihtimalina karsi
...
/* ----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/    
   ...
   delete from ogrenciler where isim='Ali Can' and '123'; 
...
/* ----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/     
   ...
   SET autocommit=0;-- kapatip acmadan ayarlari etkinlestirir
    
    rollback to abc; -- abc de kayitli olan verileri rollback ile geri getir
