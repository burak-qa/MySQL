...
/* -----------------------------------------------------------------------------
  ...
  sorguyu yaziniz.    
------------------------------------------------------------------------------*/  
select maas, isim as isim_sehir --  isim verdik
from personel
...
/* -----------------------------------------------------------------------------
  ORNEK3: Honda,Ford ve Tofas'ta calisan  personelin vismini listeleyin
------------------------------------------------------------------------------*/
...
from personel
where sirket='Honda'
union 						-- union dan sonra all yazsaydik ayni isimle olanlari da getirirdi
select isim
from personel
where sirket='Ford'
union 						-- union dan sonra all yazsaydik ayni isimle olanlari da getirirdi
...
select isim, maas, sirket
from personel
where sirket!='Honda';    -- sirket<>honda   da yazabiliriz 

/* -----------------------------------------------------------------------------
  ORNEK5: Ismi Mehmet Ozturk olanlari sehirlerini +  olarak Istanbul'da calismayanlarin isimlerini ve 
