...
-- buradaki 'c' sen ne yazarsan onu getir demek. h yi H yapsaydik ilk harf buyuk H olani getirirdi
...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
   select * from kelimeler
   where regexp_like(kelime, 'h[a|i]t'); -- 'h[ai]t' de yazabilirdik
...
/* -----------------------------------------------------------------------------
 ...
 select * from kelimeler
 where regexp_like(kelime,'[mie]'); -- [] bir karakter manasina geliyor m|i|e de olabilir
/* -----------------------------------------------------------------------------
