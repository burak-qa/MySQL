...
==============================================================================*/
 ...
 where exists(select urun_isim from mart m   -- as olmadan da calisti as yazmaya gerek yok
 ...
 -----------------------------------------------------------------------------*/
  select urun_isim, musteri_isim from nisan as n
 where not exists(select urun_isim from mart m   -- as olmadan da calisti as yazmaya gerek yok
				where n.urun_isim=m.urun_isim);
...
select * from kisiler limit 10,2; -- ilk sayi dahil degil 11 den basla, 2. say kadar git(2 tane git)
