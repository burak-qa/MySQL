...
==============================================================================*/  
   ...
   CREATE TABLE tedarikciler -- parent
    ...
    -- WHERE koşul;
      select * from tedarikciler , urunler where tedarikciler.vergi_no = urunler.ted_vergino; -- iki tabloyu ayni anda gosteriyor
/* -----------------------------------------------------------------------------
...
/*-----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/
   ...
   update urunler
   set urun_ismi=(select firma_ismi from tedarikciler where irtibat_ismi='Adam Eve') -- parantezin ici apple i kast ediyor
   where musteri_ismi='Ali Bak';
   select * from urunler;
  
/*------------------------------------------------------------------------------
 ORNEK9: Laptop satin alan musterilerin ismini, firma_isim i Apple’in irtibat_isim'i ile 
 degistirin
 -----------------------------------------------------------------------------*/
 update urunler
 set musteri_ismi=(select irtibat_ismi from tedarikciler where firma_ismi='Appel') -- parantezin ici Adam Eve yi getirir
