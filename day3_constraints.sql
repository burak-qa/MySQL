/*======================= CONSTRAINTS - KISITLAMALAR ======================================
 ...
 INSERT INTO calisanlar VALUES( '10002', 'Mehmet Yılmaz' ,12000, '2018-04-14');
   ...
   INSERT INTO calisanlar VALUES('10010', null, 5000, '2018-04-14'); -- 2. kez null benzersizlik kisitlamasini bozmaz
    ...
    INSERT INTO calisanlar VALUES('10006', 'Canan Yaş', NULL, '2019-04-12'); -- maas null olamaz hata verir!!
    INSERT INTO calisanlar VALUES('10003', 'CAN', 5000, '2018-04-14');
    INSERT INTO calisanlar VALUES('10007', 'CAN', 5000, '2018-04-14'); -- can zaten var unique hata verir!!
    INSERT INTO calisanlar VALUES('10009', 'cem', '', '2018-04-14'); -- '' ile int veremem hata verir!!
    INSERT INTO calisanlar VALUES('', 'osman', 2000, '2018-04-14');
    INSERT INTO calisanlar VALUES('10002', 'ayse yilmaz', 12000, '2018-04-14');  -- id tekrari olamaz primary key den dolayi!!
...
----------------------------------------------------------------*/
    ...
    -- parent tablo olmayan id child a ekleme yapamayiz
    
    -- FK'ye null değeri atanabilir. 
    INSERT INTO adresler VALUES(NULL,'Ağa Sok', '30.Cad.','Antep');
    
	select* from adresler;
    -- baglantili tablolarda child silinmeden parent silinemez
...
==============================================================================*/ 
    ...
    (
        id CHAR(3) primary key,  -- promary key baba dir.
        isim VARCHAR(50),
    ...
    SELECT * FROM talebeler, notlar WHERE talebeler.id = notlar.talebe_id; -- iki tabloyu birlestirdik
